<template>
    ...
    <!-- Modal for delete -->
    <Modal :title="'Do you really want to delete ' + hometown.label + ' ?'" :visible="visible.hometown_delete">
        <div class="my-3 flex justify-between">
            <button class="btn-danger w-1/3" @click="delete_hometown">Yes</button>
            <button class="btn-success w-1/3" @click="toggle_hide('hometown_delete')">No</button>
        </div>
    </Modal>
...
import {get_hometowns, delete_hometown, search_hometown} from '../Apis/hometowns-endpoints';
