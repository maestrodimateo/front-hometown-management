    ...
    <form @submit.prevent="save">
        ...
        <div class="flex flex-col my-5">
            ...
            <div class="relative">
                ...
                <div role="alert" class="alert-danger" v-if="is_success(false, 'label')" v-html="message.content.label"></div>
            </div>
        </div>
        <!-- base url field -->
        <div class="flex flex-col my-5">
            ...
            <div class="relative">
                ...
                <div role="alert" class="alert-danger" v-if="is_success(false, 'base_url')" v-html="message.content.base_url"></div>
            </div>
        </div>
